          ...
          <div className="max-w-6xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, y: 40, rotate: 3 }} animate={{ opacity: 1, y: 0, rotate: 0 }}
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 to-cyan-500/20 blur-[60px] rounded-full" />
                <img src={heroDevice} alt="VidPath auf Laptop und Smartphone" className="relative w-full max-w-lg h-auto drop-shadow-2xl" />
              </div>
            </motion.div>
          </div>
        </motion.div>
